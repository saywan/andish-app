        ...
        <div class="main-icon-menu-body">
            <div class="position-reletive h-100" data-simplebar style="overflow-x: hidden;">
                <ul class="nav nav-tabs" role="tablist" id="tab-menu">
                    ...
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title=" فاکتور شرکت اندیش گستر"
                        data-bs-trigger="hover">
                   ...
                   aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex align-items-center">
                      {{--  <img src="panel/images/users/user-4.jpg" alt="profile-user"
                        ...
                        <div>
                            <small class="d-none d-md-block font-11">داشبورد کاربری</small>
