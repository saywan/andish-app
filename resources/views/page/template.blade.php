...
<head>
    ...
    <title>
        تایید حساب کاربری شرکت اندیش گستر
    </title>
    <style>
        * {
            font-family: 'IRANSans', "IRANYekan", "B Yekan", "IPT Yekan", "B Mitra", "B Nazanin", "B Yagut", "Arial", "Tahoma";
        }
    </style>
</head>

<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0"
      style="margin: 0pt auto; padding: 0px; background:#e9defc;">
                        ...
                        <table class="logo" width="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                <td valign="top" align="center">
                                    <a href="https://frme.live" style="display:inline-block; cursor:pointer; text-align:center;">
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                        ...
                                        <tr>
                                            <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                                <img alt="تایید حساب کاربری" width="80" src="https://andishgostar.com/public/Content/images/login.jpg"   />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="30" &nbsp;=""></td>
          ...
          تایید حساب کاربری
                                        ...
                                        <tr>
                                            <td align="center">
                                                <span style="color:#48545d;font-size:14px;line-height:24px;">
                                                    ...
                                                    چهت تایید حساب کاربری خود روی لینک زیر کلیک کنید
                                              </span>
                                        ...
                                        <tr>
                                            <td valign="top" width="48%" align="center">
                                                <span>
          <a href="{{ url('VerifyAccount/'.$token) }}" style="display:block; padding:15px 25px; background-color:#0087D1; color:#ffffff; border-radius:3px; text-decoration:none;">
             ...
             تایید و فعالسازی حساب کاربری
                                        ...
                                        <tr>
                                            <td align="center">
                                                <p style="color:#a2a2a2; font-size:12px; line-height:17px; font-style:italic;">If
                                                 شرکت اندیش گستر
                                                </p>
                                            </td>
                                        </tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <a href="https://www.coinbase.com/" target="_blank" style="color:#9EB0C9 !important; text-decoration:none;">Frme</a> 2019
                          </span>
