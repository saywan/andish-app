            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">
                            لیست گروه کالایی شرکت اندیش گستر
                        </h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                                    ...
                                    @foreach($GProuct as $itemUser)
                                        <tr>
                                            ...
                                            <td>  {{
                                                ...
                                                is_null(\App\Helper\Helper::getInfoUser($itemUser->userId)) ? "کاربر یافت نشد"
                                            ...
                                            <td>
                                                @if($itemUser->unit_producte =='meter')
                                                    <span class="text-danger font-15">
                                                           متر
                                                       </span>
                                                @elseif($itemUser->unit_producte =='numerical')
                                                    <span class="text-success font-15">
                                                           عدد
                                                       </span>
                                                @elseif($itemUser->unit_producte =='kilogarm')
                                                    <span class="text-success font-15">
                                                           کیلوگرم
                                                    </span>
                                                @elseif($itemUser->unit_producte =='roll')
                                                    <span class="text-success font-15">
                                                           رول
                                                    </span>
                                                @elseif($itemUser->unit_producte =='liter')
                                                    <span class="text-success font-15">
                                                         لیتر
                                                    </span>
                                                @endif
                                            ...
                                            @if($itemUser->unit_producte == 'meter')
                                            <td class="font-15">  {{$itemUser->weight}} </td>
                                            <td class="font-15">
                                                   0
                                            </td>
                                            ...
                                            @elseif($itemUser->unit_producte=='numerical')
                                                <td class="font-15"> 0 </td>
                                                <td class="font-15">
                                                    {{
                                                      empty($itemUser->price) ? 0 : number_format($itemUser->price)
                                                    }}
                                                </td>
                                                <td>  {{$itemUser->datereg}}   </td>
                                            @endif
                                            <td>
                                                <a href="{{url('portal/GroupProduct/edit/'.$itemUser->id)}}"
                                                   title="ویرایش گروه بندی کالا">
                                                    <i data-feather="edit"></i>
                                                </a>
                                                <a @click="DeleteGroupProduct({{$itemUser->id}})"
                                                   title="حذف گروه بندی کالا">
