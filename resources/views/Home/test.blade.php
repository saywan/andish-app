...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-three">
                ...
                <div class="clearfix">
                    ...
                    <div class="top-left clearfix">
                        ...
                        <ul class="info-list">
                            ...
                            <li><a href="contact.html"><span class="icon fa fa-location-arrow"></span>
            ...
            <div class="auto-container">
                <div class="clearfix">
                    ...
                    <div class="pull-left logo-box">
                        <div class="logo"><a href="{{url('/')}}"><img src="public/Content/images/login.png" alt="" title=""></a>
                        </div>
                    </div>
                    ...
                    <nav class="main-menu show navbar-expand-md">
                        ...
                        <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                <li class="current dropdown"><a href="#">صفحه اصلی </a>
                                    <ul>
                                        <li class="dropdown">
                                            <a href="/">صفحات اصلی </a>

                                        </li>
                                        <li class="dropdown"><a href="#">سبک هدر </a>
                                            <ul>
                                                <li><a href="{{url('/')}}">سک هدر 01</a></li>
                                                <li><a href="index-2.html">سک هدر 02</a></li>
                                                <li><a href="index-3.html">سک هدر 03</a></li>
                                                <li><a href="index-4.html">سک هدر 04</a></li>
                                                <li><a href="index-5.html">سک هدر 05</a></li>
                                                <li><a href="index-6.html">سک هدر 06</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">درباره ما </a>
                                    <ul>
                                        ...
                                        <li><a href="testimonial.html">مشتریان ما </a></li>
                                        <li><a href="comming-soon.html">به زودی </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">خدمات </a>
                                    <ul>
                                        <li><a href="services.html">خدمات </a></li>
                                        <li><a href="services-detail.html">جزئیات خدمات </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">پروژه ها </a>
                                    <ul>
                                        <li><a href="projects.html">پروژه ها </a></li>
                                        <li><a href="projects-detail.html">جزئیات خدمات </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">فروشگاه </a>
                                    <ul>
                                        <li><a href="shop.html">محصولات ما </a></li>
                                        <li><a href="shop-single.html">تک محصول </a></li>
                                        <li><a href="shopping-cart.html">سبد فروشگاه </a></li>
                                        <li><a href="checkout.html">پرداخت </a></li>
                                        <li><a href="account.html">اکانت </a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">وبلاگ </a>
                                    <ul>
                                        <li><a href="blog.html">وبلاگ ما </a></li>
                                        <li><a href="blog-classic.html">وبلاگ کلاسیک </a></li>
                                        <li><a href="news-detail.html">تک نوشته </a></li>
                                        <li><a href="not-found.html">وجود ندارد </a></li>
                                    </ul>
                                </li>
                                ...
                                <div class="dropdown-menu pull-right cart-panel" aria-labelledby="dropdownMenu">
                                    ...
                                    <div class="cart-product">
                                        <div class="inner">
                                            ...
                                            <div class="image"><img src="public/Content/images/resource/post-thumb-1.jpg"
                                                                    alt=""/></div>
                                    ...
                                    <div class="cart-product">
                                        <div class="inner">
                                            <div class="cross-icon"><span class="icon fa fa-remove"></span></div>
                                            <div class="image"><img src="public/Content/images/resource/post-thumb-2.jpg"
                                                                    alt=""/></div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="{{url('/')}}" title=""><img src="public/Content/images/logo-small.png" alt="" title=""></a>
                </div>
                <!--Right Col-->
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="{{url('/')}}"><img src="public/Content/images/login.png" alt="" title=""></a></div>
                ...
                <div class="sidebar-textwidget">
                    ...
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            <div class="logo">
                                <a href="{{url('/')}}"><img src="public/Content/images/logo-2.png" alt=""/></a>
                            </div>
        ...
        <div class="auto-container">
            ...
            <div class="carousel-outer">
                ...
                <ul class="sponsors-carousel owl-carousel owl-theme">
                    <li>
                        <div class="image-box"><a href="#"><img src="public/Content/images/clients/1.png" alt=""></a></div>
                    </li>
                    <li>
                        <div class="image-box"><a href="#"><img src="public/Content/images/clients/2.png" alt=""></a></div>
                    </li>
                    <li>
                        <div class="image-box"><a href="#"><img src="public/Content/images/clients/3.png" alt=""></a></div>
                    </li>
                    <li>
                        <div class="image-box"><a href="#"><img src="public/Content/images/clients/4.png" alt=""></a></div>
                    </li>
                    <li>
                        <div class="image-box"><a href="#"><img src="public/Content/images/clients/1.png" alt=""></a></div>
                    </li>
    ...
    <section class="fluid-section-one">
        <div class="outer-container clearfix">
            ...
            <div class="image-column" style="background-image:url(images/resource/image-1.jpg)">
                <figure class="image-box"><img src="public/Content/images/resource/image-1.jpg" alt=""></figure>
            </div>
        ...
        <div class="auto-container">
            ...
            <div class="three-item-carousel owl-carousel owl-theme">
                ...
                <div class="news-block-three">
                    <div class="inner-box">
                        <div class="image">
                            <a href="news-detail.html"><img src="public/Content/images/resource/news-5.jpg" alt=""/></a>
                        </div>
                ...
                <div class="news-block-three style-two">
                    <div class="inner-box">
                        ...
                        <div class="image">
                            <a href="news-detail.html"><img src="public/Content/images/resource/news-6.jpg" alt=""/></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="news-block-three">
                    <div class="inner-box">
                        <div class="image">
                            <a href="news-detail.html"><img src="public/Content/images/resource/news-7.jpg" alt=""/></a>
                        </div>
                        <div class="lower-content">
                            <div class="content">
                                <div class="icon-box">
    ...
    <section class="call-to-action-section-two">
        <div class="auto-container">
            <div class="inner-container">
                <div class="image">
                    <img src="public/Content/images/resource/image-2.jpg" alt=""/>
                </div>
        ...
        <div class="outer-container">
            ...
            <div class="five-item-carousel owl-carousel owl-theme">
                ...
                <div class="case-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="public/Content/images/gallery/6.jpg" alt=""/>
                ...
                <div class="case-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="public/Content/images/gallery/7.jpg" alt=""/>
                            <div class="overlay-box">
                ...
                <div class="case-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="public/Content/images/gallery/8.jpg" alt=""/>
                            <div class="overlay-box">
                ...
                <div class="case-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="public/Content/images/gallery/9.jpg" alt=""/>
                            <div class="overlay-box">
                ...
                <div class="case-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="public/Content/images/gallery/10.jpg" alt=""/>
                            <div class="overlay-box">
            ...
            <div class="row clearfix">
                ...
                <div class="news-block-four col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="news-detail.html"><img src="public/Content/images/resource/news-8.jpg" alt=""/></a>
                        </div>
                        <div class="lower-content">
                ...
                <div class="news-block-four col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="news-detail.html"><img src="public/Content/images/resource/news-9.jpg" alt=""/></a>
                        </div>
                        <div class="lower-content">
                            <div class="post-date">22 <span>خرداد </span></div>
                ...
                <div class="news-block-four col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="news-detail.html"><img src="public/Content/images/resource/news-10.jpg" alt=""/></a>
                        </div>
                        <div class="lower-content">
                            <div class="post-date">22 <span>خرداد </span></div>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="logo-column col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-column">
                        <div class="logo">
                            <a href="{{url('/')}}"><img src="public/Content/images/hlogo-2.png" alt=""/></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="footer-column col-lg-4 col-md-6 col-sm-12">
                        <div class="footer-widget logo-widget">
                            <h5>درباره گلوبکس</h5>
                            <div class="text">ما بهترین شرکت فناوری اطلاعات جهان هستیم. ارائه بالاترین کیفیت در سخت
                                افزار و راه حل های شبکه. حدود بیش از 25 سال تجربه و 1000 دستاورد ابتکاری. <br><br> از
                                این فرهنگ لغت با بیش از 200 کلمه لاتین استفاده شده استفاده می شود بنابراین مجاز است.
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="emailed-form">
                                <form method="post" action="https://expert-themes.com/html/globex/contact.html">
                                    <div class="form-group">
                                        <input type="email" name="email" value="" placeholder="ایمیل خود را وارد کنید"
                                               required>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="column col-lg-6 col-md-12 col-sm-12">
                        <div class="copyright">کپی رایت 1400 | طراحی سایت و توسعه قالب توسط جعفر عباسی. تمام حقوق سایت
                            محفوظ می باشد..
                        </div>
                    </div>
                    <!-- Column -->
